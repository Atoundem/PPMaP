	...
	private void changeImage(){
		try {
			...
			if(MainPageWizardPage.getSeveralModels())
				MaizeDevRate.estimateParameters(c,model, true, false, "", "", "", "", "","");
			else{
				String str1,str2,str3,str4,str5, str6;
				str1 = MaizeDevRate.pars.getParameters()[0];
				str2 = MaizeDevRate.pars.getParameters()[1];
				str3 = MaizeDevRate.pars.getParameters()[2];
				str4 = MaizeDevRate.pars.getParameters()[3];
				str5 = MaizeDevRate.pars.getParameters()[4];
				str6 = MaizeDevRate.pars.getParameters()[5];
				MaizeDevRate.estimateParameters(c,model, false, true, str1, str2, str3, str4, str5, str6);
			}
