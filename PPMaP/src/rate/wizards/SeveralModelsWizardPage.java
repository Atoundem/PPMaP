...
public class SeveralModelsWizardPage extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		fd_lblStageSelected.top = new FormAttachment(0, 10);
		...
		fd_textStageSelected.top = new FormAttachment(lblStageSelected, 0, SWT.TOP);
		fd_textStageSelected.left = new FormAttachment(0, 136);
		...
		fd_lblStageSelected.left = new FormAttachment(lblModel, 0, SWT.LEFT);
		...
		fd_lblSelectedAlgo.top = new FormAttachment(lblStageSelected, 4);
		...
		fd_tableCriterias.top = new FormAttachment(textAlgoSelected, 31);
		...
		fd_textAlgoSelected.top = new FormAttachment(textStageSelected, 6);
		fd_textAlgoSelected.right = new FormAttachment(100, -195);
		fd_textAlgoSelected.left = new FormAttachment(lblSelectedAlgo, 5);
