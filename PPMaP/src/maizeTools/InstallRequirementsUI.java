...
//package org.cgiar.cip.ilcym.connectiontor;
...
public class InstallRequirementsUI {
	...
	public void createContents() {
		...
		btnBrowseInstallers.setToolTipText("Look for \"ILCYM/Requirements\"");
		...
		label.setImage(ResourceManager.getPluginImage("org.cgiar.cip.ilcym.connectiontor", "icons/R path4.png"));
		...
		btnBrowseInstallers.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				dialog.setFilterPath("\\ILCYM\\Requirements");
				dialog.open();
