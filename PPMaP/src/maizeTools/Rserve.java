...
public class Rserve {
	...
	public static void installWinRequisites(){
		...
		arrayInstallResume[0][0] = "Is R 2.15.1 installed in " +'"' + "C:\\" + '"' + '?';
	...
	public static void installMacRequisites(){
		...
		arrayInstallResume[0][0] = "Is R 2.15.1 installed ?";
		...
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/Rserve/").exists())
			arrayInstallResume[1][1] = "Installed";
		else
			arrayInstallResume[1][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/minpack.lm/").exists())
			arrayInstallResume[2][1] = "Installed";
		else
			arrayInstallResume[2][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/R2HTML/").exists())
			arrayInstallResume[3][1] = "Installed";
		else
			arrayInstallResume[3][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/sp/").exists())
			arrayInstallResume[4][1] = "Installed";
		else
			arrayInstallResume[4][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/epiR/").exists())
			arrayInstallResume[5][1] = "Installed";
		else
			arrayInstallResume[5][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/maps/").exists())
			arrayInstallResume[6][1] = "Installed";
		else
			arrayInstallResume[6][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/rgdal/").exists())
			arrayInstallResume[7][1] = "Installed";
		else
			arrayInstallResume[7][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/maptools/").exists())
			arrayInstallResume[8][1] = "Installed";
		else
			arrayInstallResume[8][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/rgl/").exists())
			arrayInstallResume[9][1] = "Installed";
		else
			arrayInstallResume[9][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/raster/").exists())
			arrayInstallResume[10][1] = "Installed";
		else
			arrayInstallResume[10][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/RColorBrewer/").exists())
			arrayInstallResume[11][1] = "Installed";
		else
			arrayInstallResume[11][1] = "Not Installed";
		if(new File("/Library/Frameworks/R.framework/Versions/2.15/Resources/library/shapefiles/").exists())
	...
	public static void installSoftwares(String strPath, int intItem, Table table){
		...
		case 0:/** R 2.15.1 **/
			if(state.equalsIgnoreCase("Installed")){
				MessageDialog.openInformation(new Shell(), "System Requirements", "R-2.15.1 is alredy installed.");
				return;
			}
			try {
				Runtime.getRuntime().exec(strPath + File.separator+ "R" + File.separator + "R-2.15.1-win.exe");
		...
		case 1:/** Rserve**/
			...
			try {
				c.eval("install.packages(pkgs=" + '"' + strPath +  "minpack.lm_1.1-6.zip" + '"' + ",repos=NULL, contriburl=NULL)");
